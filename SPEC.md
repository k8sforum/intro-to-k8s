...
| GET | `/api/pointofinterest/search?term=&rows=&start=` | query `term` (free text over address, tags and description), optional `rows` (default 100), `start` | `List<PointOfInterestDto>` | 200 | none |
