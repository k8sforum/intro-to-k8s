...
images=(
    "tshepontlhokoa/mytravels-migrations:v1.0.2"
    "tshepontlhokoa/mytravels-api:v1.0.6"
    "tshepontlhokoa/mytravels-messaging:v1.0.8"
    "tshepontlhokoa/mytravels-web:v1.0.3"
)
